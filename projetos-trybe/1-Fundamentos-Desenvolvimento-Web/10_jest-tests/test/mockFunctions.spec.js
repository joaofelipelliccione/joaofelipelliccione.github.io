const mockFunctions = require('../src/mockFunctions'); // Importando todas as funções disponíveis no arquivo 'mockFunctions.js'.

jest.mock('../src/mockFunctions'); // Transformando todas as funções disponíveis no arquivo 'mockFunctions.js', em mocks, de uma só vez.
