...
function randomColors() {
  ...
  for (let index = 1; index < paletteColorsArray.length; index += 1) {
    const randomId = colorsPaletteArray[Math.floor(Math.random() * colorsPaletteArray.length)]; // ref: https://css-tricks.com/snippets/javascript/select-random-item-array/
